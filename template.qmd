...
\textcolor{gublue}{**`r lang`**} von 15 möglichen Punkten.
...
\textcolor{gublue}{**`r frage`**} von 10 möglichen Punkten.
...
\textcolor{gublue}{**`r aufbau`**} von 30 möglichen Punkten.
...
\textcolor{gublue}{**`r arg`**} von 35 möglichen Punkten.
...
\textcolor{gublue}{**`r formalia`**} von 30 möglichen Punkten. von 10 möglichen Punkten.

\newpage

# Gesamtbetrachtung

Insgesamt wird der Arbeit die Note \textcolor{gublue}{**`r note`**} erteilt. Es wurden \textcolor{gublue}{**`r punkte`**} von 100 möglichen Punkten erreicht.
